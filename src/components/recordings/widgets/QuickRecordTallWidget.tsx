...
/**
 * Tall narrow variant of QuickRecordCard: same gradient + button, but the
 * content stretches vertically so the widget can occupy a full-height
 * column without leaving empty space below.
 */
export function QuickRecordTallWidget() {
  ...
  return (
    <button
      ...
      className={[
        "card h-full w-full p-3 transition-all",
    ...
    >
      ...
      <span className="btn-primary !py-1.5 !px-3 pointer-events-none w-full justify-center">
