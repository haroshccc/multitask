...
export const LIST_ICON_PRESETS: ListIconPreset[] = [
  ...
  // New icons
  { key: "goal",           icon: Target,          label: "מטרה" },
  { key: "briefcase",      icon: Briefcase,       label: "עסקים" },
  { key: "sharing",        icon: Share2,          label: "שיתוף" },
  { key: "merge",          icon: Merge,           label: "איחוד" },
  { key: "target",         icon: Flag,            label: "יעד" },
  { key: "habit",          icon: RepeatIcon,      label: "הרגל" },
  { key: "medical",        icon: HeartPulse,      label: "רפואה" },
  { key: "sport",          icon: Bike,            label: "ספורט" },
  { key: "food",           icon: Salad,           label: "אוכל" },
  { key: "dance",          icon: Music2,          label: "ריקוד" },
  { key: "compass",        icon: Compass,         label: "מצפן" },
  { key: "map",            icon: Map,             label: "מפה" },
  { key: "hobby",          icon: Gamepad2,        label: "תחביב" },
  { key: "nature",         icon: Leaf,            label: "טבע" },
  { key: "star",           icon: Star,            label: "כוכב" },
  { key: "car",            icon: Car,             label: "רכב" },
  { key: "flight",         icon: Plane,           label: "טיסה" },
  { key: "office",         icon: Building2,       label: "משרד" },
  { key: "coffee",         icon: Coffee,          label: "קפה" },
  { key: "scissors",       icon: Scissors,        label: "עיצוב שיער" },
  { key: "camera",         icon: Camera,          label: "צילום" },
];
