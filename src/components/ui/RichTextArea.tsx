...
export function RichTextArea({
  ...
  // Saved range for restoring selection before execCommand.
  const savedRange = useRef<Range | null>(null);

  // Sync value → editor only on mount (controlled-but-not-fully: avoid cursor jump).
  ...
  // When external value resets to "" (e.g., after task save), clear editor.
  useEffect(() => {
  ...
  const updateToolbar = useCallback(() => {
    ...
    // Only show toolbar if selection is inside editor.
